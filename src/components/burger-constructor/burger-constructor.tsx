...
function BurgerConstructor(props: IProps) {
    ...
    const targetBun = useMemo(()=>props.ingredients.find(o=>o.type===IngridientTypes.Bun)!, [props.ingredients]);
    const notBunIngredients = useMemo(()=>props.ingredients.filter(o=>o.type!==IngridientTypes.Bun), [props.ingredients]);
    const totalSum = useMemo(()=>props.ingredients.reduce((s, o)=>s+o.price,0), [props.ingredients]);
    return (<>
                <div>
